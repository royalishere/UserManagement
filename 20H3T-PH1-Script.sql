...
-- create foreign keys
ALTER TABLE NHANVIEN
    ADD CONSTRAINT NHANVIEN_FK_NQL FOREIGN KEY (MANQL) REFERENCES NHANVIEN(MANV)
    ADD CONSTRAINT NHANVIEN_FK_PHG FOREIGN KEY (PHG) REFERENCES PHONGBAN(MAPB);


ALTER TABLE PHONGBAN
    ADD CONSTRAINT PHONGBAN_FK_TRPHG FOREIGN KEY (TRPHG) REFERENCES NHANVIEN(MANV);
    
ALTER TABLE DEAN
    ADD CONSTRAINT DEAN_FK_PHONG FOREIGN KEY (PHONG) REFERENCES PHONGBAN(MAPB);
    
ALTER TABLE PHANCONG
    ADD CONSTRAINT PHANCONG_FK_NV FOREIGN KEY (MANV) REFERENCES NHANVIEN(MANV)
    ADD CONSTRAINT PHANCONG_FK_DA FOREIGN KEY (MADA) REFERENCES DEAN(MADA);
